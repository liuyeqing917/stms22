...
class ExamController extends CommonController
{
    ...
    {
        $dataArray=$request->only('tid','department_id','start','end','classroom','type','teacher');
       ...
       $zz= $exam-> iftimeyiyang($dataArray);
        ...
        if($zz['code']!=1){
            ...
            for($i=0;$i<count($dataArray['department_id']);$i++){
                ...
                $addArray = [
                    ...
                    'end' =>$dataArray['end'],
                    'classroom' =>$dataArray['classroom'][$i],
                    'type' =>$dataArray['type'],
                    'teacher' =>$dataArray['teacher'][$i]
                ];
